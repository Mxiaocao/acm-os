...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ipc::contest_library_delete_family,
            ipc::contest_library_list_series,
            ipc::contest_library_create_series,
            ipc::contest_library_rename_series,
            ipc::contest_library_delete_series,
            ipc::contest_library_list_year_entities,
            ipc::contest_library_create_year,
            ipc::contest_library_rename_year,
            ipc::contest_library_delete_year,
