...
export function App() {
  ...
  return (
    <>
      <RouteAnnouncement message={route.kind === "normal" ? normalPageLabel(route.page) : "Page not found"} />
      <NormalAppShell
        foundation={foundation}
        key={route.kind === "normal" ? route.page : route.pathname}
        navigate={navigate}
        route={route}
...
function routeAnnouncement(
  ...
  return route.kind === "normal" ? normalPageLabel(route.page) : "Page not found";
}
